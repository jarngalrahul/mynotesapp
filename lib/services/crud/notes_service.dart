...
//     //just here for checking not intereseted in the result
...
//     const text = '';
//     //Create the note
//     final int noteId = await db.insert(notesTable, {
...
//     final int userId = await db.insert(userTable, {
...
//     await _ensureDbIsOpen();
//     final Database db = _getDatabaseOrThrow();
//     final int deletedAccount = await db.delete(
//       userTable,
//       where: 'email = ?',
//       whereArgs: [email.toLowerCase()],
//     );
